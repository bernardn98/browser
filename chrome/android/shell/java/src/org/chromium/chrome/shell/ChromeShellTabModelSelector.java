...
class ChromeShellTabModelSelector extends TabModelSelectorBase {
    ...
    public ChromeShellTabModelSelector(
        ...
        TabModel tabModel = new ChromeShellTabModel(mOrderController, tabModelDelegate, false);
        TabModel icognitotabModel = new ChromeShellTabModel(mOrderController, tabModelDelegate, true);
        initialize(false, tabModel, icognitotabModel); //EmptyTabModel.getInstance()
